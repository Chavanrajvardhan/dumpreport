...
//         const refererUrl = `https://testapp1.rediport.in/dashboardparam/territoryreport?franchise=${encodeURIComponent(franchise)}&selectedDate=${encodeURIComponent(MonthDate)}&rowData=%20&templateName=GSG%20&distributorId=${encodeURIComponent(distributorId)}&orgSegment=${encodeURIComponent(orgSegment)}`;
