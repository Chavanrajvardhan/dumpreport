...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log(" segment api hit here");
        ...
        const res = await axios.post(
            "https://testapp1.rediport.in/api/TransactionReport/getorgsegment",
            {},
            headersInfo
        );
        ...
        return NextResponse.json(
            { message: "Organisation segment fetched successfully", status: 200, result: res.data },
            { status: 200 }
        );
